  ...
  render: ({ trace, element }) => {
    ...
    const messageSequences = {
      ...
      en: {
        ...
        all: {
          KB: [
            'Browsing the Litovel database.',
            'Verifying available facts.',
            'Preparing response.'
          ],
          KB_WS: [
            'Searching the Litovel database.',
    ...
    try {
      ...
      // Vytvoření kontejneru s vlastním stylem
      ...
      // Funkce pro animaci přepisu textu
      let currentIndex = 0;
      ...
      // Interval pro postupné změny textu
      let intervalId = null;
      ...
      // Po uplynutí času animaci skryjeme
      ...
      // Sledujeme odebrání elementu (např. při přechodu konverzace)
      ...
      // Sledujeme, kdy přijde AI odpověď a ukončíme animaci
